...
{
	Vision_Region[0].top    =  6.8;
	Vision_Region[0].bottom =  0.0;
	Vision_Region[0].left   =  0.2; 
	Vision_Region[0].right  =  -5.9;	
	
	Vision_Region[1].top    =  4.0;
	Vision_Region[1].bottom =  1.81;
	Vision_Region[1].left   =  -4.5; 
	Vision_Region[1].right  =  -6.2;	
}

void init_vision_speed_region(void)
{
	Vision_Speed_Region[0].top    =  4.0;
	Vision_Speed_Region[0].bottom =  0.0;
	Vision_Speed_Region[0].left   =  -0.5; 
	Vision_Speed_Region[0].right  =  0.5;
	
    Vision_Speed_Region[1].top    =  6.0;
	Vision_Speed_Region[1].bottom =  3.0;
	Vision_Speed_Region[1].left   =  1.0; 
	Vision_Speed_Region[1].right  =  -4.0;		
	
	Vision_Speed_Region[2].top    =  4.5;
	Vision_Speed_Region[2].bottom =  1.0;
	Vision_Speed_Region[2].left   =  -5.0; 
	Vision_Speed_Region[2].right  =  -6.0;		
}

void init_waypoint_region(void)
{
	
	WayPoint_Region[0].top    =  6.8;
	WayPoint_Region[0].bottom =  0.3;
	WayPoint_Region[0].left   =  -5.9; 
	WayPoint_Region[0].right  =  -7.68;
...
{
	my_waypoints_list[0].y = 0.2;   
    my_waypoints_list[0].x = 0.6;
  
    my_waypoints_list[1].y = -0.2;   
    my_waypoints_list[1].x =  1.5;  		
    
    my_waypoints_list[2].y = -7.3;   
    my_waypoints_list[2].x = 0.8; 
    
    my_waypoints_list[3].y = -7.1;   
    my_waypoints_list[3].x = 0.8;  		
    
    my_waypoints_list[4].y = -5.1;   
    my_waypoints_list[4].x = 0.8;  	
